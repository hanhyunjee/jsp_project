...
<br><br>
<a  class="cls1" href="${contextPath}/board/articleForm.do"><center><input type='button' value='글쓰기'/></center></a><br>
<a  class="cls1"  href="${contextPath}/main.jsp"><center><input type='button' value='홈으로'/></center></a>
</body>
</html>